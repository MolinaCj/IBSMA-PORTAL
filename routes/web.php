...
// Route to generate and download TOR
Route::post('/admin/students/{student}/tor', [StudentController::class, 'updateTor'])->name('admin.save.student.tor');
Route::get('/admin/students/{student}/tor', [StudentController::class, 'downloadTor'])->name('admin.download.student.tor');
Route::get('/records', [StudentController::class, 'records'])->name('admin.records');
Route::put('/admin/{student}/records', [StudentController::class, 'updateRecords'])->name('records.update');
