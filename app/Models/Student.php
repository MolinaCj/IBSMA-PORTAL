...
class Student extends Authenticatable
{
    ...
    public function subjects()
    {
        return $this->belongsToMany(Subject::class, 'grades', 'student_id', 'subject_id')
                    ->withPivot('grade', 'year_level', 'semester', 'credited', 'school_year')
                    ->withTimestamps();
    }
    ...
    public static function getAvailableYears()
{
    ...
    public function tor()
    {
        return $this->hasOne(Tor::class, 'student_id', 'student_id');
    }

    public function formerSubject()
    {
        return $this->hasMany(FormerSubject::class, 'student_id', 'student_id');
    }
}
